...
import { FaUsers, FaAddressCard, FaPlusSquare } from "react-icons/fa"
...
export default function ContentButtons() {
    ...
    return (
        <div className={styles.body}>
            ...
            <div className={styles.wrapper} onClick={() => navigate("/createRoom")}>
                <FaPlusSquare className={styles.icon} />
                <span className={styles.text}>Создать комнату</span>
            </div>
        </div>
    )
}